      ...
      <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);"
        ...
        <div class="user-nav d-sm-flex d-none">
          ...
          <span class="user-status">
            @if(Auth::user()->user_type == 1){{"Admin"}}@elseif(Auth::user()->user_type == 2){{"Customer"}}@elseif(Auth::user()->user_type == 3){{"Reseller"}}@elseif(Auth::user()->user_type == 4){{"Sub Reseller"}}@endif
          </span>
        </div>
        <span class="avatar">
          <img class="round"
