    ...
    transit: function transit(callback1, callback2) {
      ...
      if ($body.hasClass('vertical-layout')) {
        if ($body.hasClass('menu-open') || $body.hasClass('menu-expanded')) {
          ...
          $(".nav-logo").removeClass('d-none'); // Show menu header search when menu is normally visible
          ...
          $(".nav-logo").addClass('d-none'); // Hide menu header search when only menu icons are visible
